...
class User extends Authenticatable
{
    ...
    {
        return [
            'email_verified_at' => 'datetime', // Mengubah nilai ke format DateTime saat diambil dari database
            'password' => 'hashed',  // Menggunakan hashing untuk menyimpan password dengan aman
        ];
    }
}
